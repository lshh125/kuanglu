...
class CellInteract(nn.Module):
    def __init__(self, d_gene, d_embed):
        ...
        self.spatial_scale = nn.Parameter(torch.tensor(10.))
    ...
    def forward(self, expression, encoding, sqr_pdist=None):
        ...
        if sqr_pdist is not None:
            spatial_scaling = torch.exp(- sqr_pdist / (self.spatial_scale ** 2))
...
class Model(nn.Module):
    ...
    def forward(self, raw_expr, interact, sqr_pdist):
